...
class WebMenuExtenderPass implements CompilerPassInterface
{
    /**
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $taggedServices = $container->findTaggedServiceIds('oswis.web_menu_extender'); // find all service IDs with the app.mail_transport tag
