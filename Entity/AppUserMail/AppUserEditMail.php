...
#[ApiResource(
    operations: [
        new GetCollection(
            normalizationContext: ['groups' => ['app_user_edit_mails_get'], 'enable_max_depth' => true],
            security: "is_granted('ROLE_ADMIN')",
        ),
        new Post(
            denormalizationContext: ['groups' => ['app_user_edit_mails_post'], 'enable_max_depth' => true],
            security: "is_granted('ROLE_ADMIN')",
        ),
        new Get(
            normalizationContext: ['groups' => ['app_user_edit_mail_get'], 'enable_max_depth' => true],
            security: "is_granted('ROLE_ADMIN')",
        ),
        new Put(
            denormalizationContext: ['groups' => ['app_user_edit_mail_put'], 'enable_max_depth' => true],
            security: "is_granted('ROLE_ADMIN')",
        ),
    ],
    filters: ['search'],
...
#[UniqueConstraint(name: 'uniq_app_user_edit_mail_delivery_key', columns: ['delivery_key'])]
