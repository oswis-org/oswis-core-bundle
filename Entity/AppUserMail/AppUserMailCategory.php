 ...
 *     "normalization_context"={"groups"={"app_user_e_mail_templates_get"}, "enable_max_depth"=true},
 *     "denormalization_context"={"groups"={"app_user_e_mail_templates_post"}, "enable_max_depth"=true}
 *   },
 ...
 *     "get"={
 *       "access_control"="is_granted('ROLE_ADMIN')",
 *       "normalization_context"={"groups"={"app_user_e_mail_template_get"}, "enable_max_depth"=true},
 *     },
 *     "put"={
 *       "access_control"="is_granted('ROLE_ADMIN')",
 *       "denormalization_context"={"groups"={"app_user_e_mail_template_put"}, "enable_max_depth"=true}
 *     }
 *   }
 * )
